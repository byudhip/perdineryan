...
function initFooter() {
  ...
  const creditImg = CreateElement("p", null, null, "Images generated by DALL-E");
  body.appendChild(creditImg);
  const creditFont = CreateElement("p", null, null, "Font by ");
  const fontMaker = CreateElement("a", null, null, "Typeline Studio");
